...
$(document).ready(function() {
    ...
    $('.js-add-xc').click(function() {
        ...
        //添加购物车
    $('.js-add-cart').click(addCart)
});
function addCart(e) {
    e.stopPropagation();
    var number = Number($(this).parents(".js-line-parents").find(".priceInput").val());
    var productimg = $(this).parents(".js-line-parents").find(".js-img").children("img"),
